...
Fiscal is built on **envelope budgeting**, the same system financial advisors have recommended for decades. It's the approach used by Actual Budget, YNAB, and every "zero-based budgeting" tool out there. Here's how it works and why it's effective.
...
Budget until "To Budget" is $0. If you have money sitting in "To Budget," it's unassigned. It has no plan, and unplanned money tends to get spent without thought.
...
When you earn money, whether a paycheck, a freelance payment, or a refund, it lands in "To Budget." From there, you assign it to categories.
...
- A $600 insurance bill every 6 months means budgeting $100 per month to "Car Insurance"
...
If you're carrying credit card debt and can't pay the full statement balance each month, see the [Credit Cards reference](/docs/skills/references/credit-cards) for the debt paydown strategy.
